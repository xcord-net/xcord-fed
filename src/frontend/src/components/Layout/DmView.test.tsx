...
// Stub heavy children. DmView renders one conversation and nothing else:
// MessageList + TypingIndicator + MessageCompose, or empty.
...
describe('DmView', () => {
  ...
  it('renders nothing when only dmConversationId is set (channelId missing)', () => {
    const { queryByTestId } = render(() => (
  ...
  it('renders nothing when only channelId is set (dmConversationId missing)', () => {
    const { queryByTestId } = render(() => (
