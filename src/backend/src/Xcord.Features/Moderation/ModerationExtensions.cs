...
public static class ModerationExtensions
{
        ...
        CancellationToken ct)
    {
        ...
        var moderatorHighest = await roleService.GetHighestGroupPosition(moderatorId, serverId);
        var targetHighest = await roleService.GetHighestGroupPosition(targetUserId, serverId);
